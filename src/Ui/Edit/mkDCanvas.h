...
namespace mk
{
	class MK_UI_EXPORT DProcessInput : public Device
	{
	public:
	...
	class MK_UI_EXPORT DProcessOutput : public Device
	{
	public:
	...
	class MK_UI_EXPORT DProcess : public Device, public Process::Observer
	{
	public:
	...
	class MK_UI_EXPORT DInsertNode : public Device
	{
	public:
	...
	class MK_UI_EXPORT DScriptCanvas : public Stack
	{
	public:
	...
	class MK_UI_EXPORT DScriptEditor : public Device
	{
	public:
	...
	class MK_UI_EXPORT DProcessDisplay : public DProcess
	{
	public:
	...
	class MK_UI_EXPORT NodeStructure : public DProcess
	{
	public:
	...
	class MK_UI_EXPORT NodeConstruct : public DProcess
	{
	public:
