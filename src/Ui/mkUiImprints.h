...
#ifndef MKUIIMPRINTS_H
#define MKUIIMPRINTS_H
...
#include <Object/Memory/mkMemory.h>
#include <Object/Memory/mkMultiPool.h>
#include <Object/Memory/mkPoolMake.h>
#include <Object/Util/mkUnique.h>
#include <Object/mkModule.h>
...
namespace mk
{
	...
	void Widget_device(Object& object, Lref& ref) { ref->setobject(*object.as<Widget>().device()); }
    Object* Widget_device_object(Object& object) { return object.as<Widget>().device(); }
    ...
    private:
        mkUi()
        {
            ...
            typecls<FrameType>().imprint().initEnum(StringVector({ "FRAME", "STRIPE", "LAYER", "LAYER3D" }));
            ...
            InkStyle::cls().imprint().addMember(make_unique<Member>(typecls<bool>(), 8, "textWrap", &InkStyle_textWrap, nullptr, false, false));
            InkStyle::cls().imprint().addMember(make_unique<Member>(BoxFloat::cls(), 9, "borderWidth", &InkStyle_borderWidth, nullptr, true, false, &InkStyle_borderWidth_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(BoxFloat::cls(), 10, "cornerRadius", &InkStyle_cornerRadius, nullptr, true, false, &InkStyle_cornerRadius_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(typecls<bool>(), 11, "weakCorners", &InkStyle_weakCorners, nullptr, false, false));
            InkStyle::cls().imprint().addMember(make_unique<Member>(BoxFloat::cls(), 12, "padding", &InkStyle_padding, nullptr, true, false, &InkStyle_padding_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(BoxFloat::cls(), 13, "margin", &InkStyle_margin, nullptr, true, false, &InkStyle_margin_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(DimAlign::cls(), 14, "align", &InkStyle_align, nullptr, true, false, &InkStyle_align_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(DimFloat::cls(), 15, "linearGradient", &InkStyle_linearGradient, nullptr, true, false, &InkStyle_linearGradient_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(Image::cls(), 16, "image", &InkStyle_image, nullptr, false, false, &InkStyle_image_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(Image::cls(), 17, "overlay", &InkStyle_overlay, nullptr, false, false, &InkStyle_overlay_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(Image::cls(), 18, "tile", &InkStyle_tile, nullptr, false, false, &InkStyle_tile_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(ImageSkin::cls(), 19, "imageSkin", &InkStyle_imageSkin, nullptr, true, false, &InkStyle_imageSkin_object));
            InkStyle::cls().imprint().addMember(make_unique<Member>(Shadow::cls(), 20, "shadow", &InkStyle_shadow, nullptr, true, false, &InkStyle_shadow_object));
            ...
            // Inputmk::Colour
            Input<mk::Colour>::cls().imprint().setup("Input<mk::Colour>", OBJECT);
            Input<mk::Colour>::cls().imprint().initObject(false);
            ...
            Widget::cls().imprint().addMember(make_unique<Member>(Device::cls(), 4, "device", &Widget_device, nullptr, false, false, &Widget_device_object));
            ...
            m_rootTypes.push_back(&Caret::cls());
            ...
            m_rootTypes.push_back(&Input<mk::Colour>::cls());
		...
		static mkUi instance;
        
    public:
        static mkUi& module() { return instance; }
	};
