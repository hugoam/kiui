...
#ifndef MK_DEVICESTACK_H
#define MK_DEVICESTACK_H

/* mk headers */
#include <Object/Iterable/mkVectorObserver.h>
...
namespace mk
{
	...
	class MK_UI_EXPORT StackCallback
	{
	public:
	...
	class MK_UI_EXPORT Stack : public Device, public StoreObserver<TypeObject>, public StoreObserver<Object>
	{
	public:
	...
	class MK_UI_EXPORT PickCallback : public StackCallback
	{
	public:
	...
	class MK_UI_EXPORT StoreCallback : public StackCallback
	{
	public:
	...
	class MK_UI_EXPORT SelectCallback : public StackCallback
	{
	public:
