...
#ifndef MK_INPUTDEVICE_H
#define MK_INPUTDEVICE_H
...
namespace mk
{
	struct MK_UI_EXPORT InputEvent
	{
	...
	class MK_UI_EXPORT Keyboard : public InputDevice
	{
	public:
	...
	class MK_UI_EXPORT MouseButton : public InputDevice
	{
	public:
	...
	class MK_UI_EXPORT Mouse : public InputDevice
	{
	public:
