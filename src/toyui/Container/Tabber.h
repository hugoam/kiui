...
namespace toy
{
	...
	{
	public:
		TabHeader(Piece& parent, const string& label, const Trigger& trigger);
	...
	{
	public:
		Tab(Piece& parent, Tabber& tabber, Button& header, bool active);
	...
	{
	public:
		Tabber(Piece& parent, Type& type = cls(), bool downtabs = false);
		~Tabber();
