...
namespace toy
{
	class TOY_UI_EXPORT FillerX : public Widget
	{
	public:
		FillerX();
	...
	class TOY_UI_EXPORT FillerY : public Widget
	{
	public:
		FillerY();
	...
	class TOY_UI_EXPORT ProgressBar : public Sheet
	{
	public:
	...
	class TOY_UI_EXPORT ProgressBarX : public ProgressBar
	{
	public:
		ProgressBarX();
	...
	class TOY_UI_EXPORT ProgressBarY : public ProgressBar
	{
	public:
		ProgressBarY();
