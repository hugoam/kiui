...
namespace toy
{
	class TOY_UI_EXPORT GlfwRenderWindow : public RenderWindow
	{
	public:
	...
	class TOY_UI_EXPORT GlfwInputWindow : public InputWindow
	{
	public:
	...
	class TOY_UI_EXPORT GlfwContext : public Context
	{
	public:
